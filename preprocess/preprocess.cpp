...
int main() {
	...
	std::ifstream myfile_2 ("english_wsj_train.conll"); //rewrite only the sentences that include less than 50 tokens
	if (myfile_2.is_open()) {
		int curr_sentence = -1;
		std::ofstream output_file ("english_wsj_train_edited.conll");
